"""
ChainAlpha — Monte Carlo supply-chain disruption simulator.
...
app = FastAPI(title="ChainAlpha Monte Carlo Worker", version="1.0.0")

N_SIMS = int(os.getenv("N_SIMS", "5000"))
WORKER_NAME = os.getenv("WORKER_NAME", "chainalpha-supply-sim")
